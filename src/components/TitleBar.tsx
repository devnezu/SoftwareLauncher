      ...
      <div className="flex items-center gap-3" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            title="Minimizar"
          >
            <Minus className="w-3.5 h-3.5 opacity-60 group-hover:opacity-100 transition-opacity" strokeWidth={1.5} />
          </button>
          <button
          ...
          >
            <Square className="w-3.5 h-3.5 opacity-60 group-hover:opacity-100 transition-opacity" strokeWidth={1.5} />
          </button>
          <button
            onClick={handleClose}
